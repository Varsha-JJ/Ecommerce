...
driver.get("http://127.0.0.1:8000/product_detail/18/")

category_field = driver.find_element(By.NAME, "size")
category_field .send_keys("6-9 M")

driver.get("http://127.0.0.1:8000/addcart/18/")

time.sleep(5)
product_addcart = driver.find_element(By.XPATH, "//h2[contains(text(), 'categories')]")
